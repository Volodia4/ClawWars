...
public class HealthDefenseInitializer : MonoBehaviour
{
    public static HealthDefenseInitializer Instance;
    ...
    private int warriorHealth, magicianHealth;
    private int initialHP_P1, initialHP_P2, currentHP_P1, currentHP_P2;
    ...
    private void Update()
    {
        HealthP1.text = currentHP_P1.ToString();
        HealthP2.text = currentHP_P2.ToString();

        healthBarP1.fillAmount = (float)currentHP_P1 / (float)initialHP_P1;
        healthBarP2.fillAmount = (float)currentHP_P2 / (float)initialHP_P2;

        DefenseP1.text = currentDef_P1.ToString();
        DefenseP2.text = currentDef_P2.ToString();
    }
}
